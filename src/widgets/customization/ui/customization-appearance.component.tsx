...
export const CustomizationAppearance = () => {
  ...
  return (
    <form onSubmit={handleSave} className="flex flex-col">
      <section className="flex gap-8 px-7 py-6 border-b border-gray-200">
              ...
              {CARD_STYLE_OPTIONS.map((option) => {
                ...
                return (
                  ...
                  >
                    ...
                    />
                    <span className={clsx("text-xs font-gotham", isSelected ? "text-primary-600 font-medium" : "text-gray-500")}>{option.label}</span>
                  </button>
                );
              })}
            </div>
      ...
      <div className="flex items-center justify-between px-7 py-3.5 border-t border-gray-200">
